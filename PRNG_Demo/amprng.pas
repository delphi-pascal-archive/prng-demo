...
type
  ...
  const
    ...
    procedure Crypt(var buffer: array of byte; len: integer);
...
constructor TAMPRNG.Create(const key: array of byte; const kl: integer{$IFDEF PARANOID};
  useiv: boolean = False{$ENDIF}  );
var
  i: integer;
begin
